...
2. If baremetal is target installed environment, the jumpserver needs 3 physical ethernet ports, 2 ports(for Managerment/Installation, IPMI) connects with baremetals, 1 ports connects with externel network. Baremetal neets to be same.
