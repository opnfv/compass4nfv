...
def create_inventory_file(inventories_path, hostvars,kube_master,etcd,kube_node):
    content = Environment().from_string(INVENTORY_TEMPLATE) \
        .render(hostvars=hostvars, kube_master=kube_master, \
...
def main(inventories_path, local_inventory):
    ...
    create_inventory_file(inventories_path, hostvars,kube_master,etcd,kube_node)
